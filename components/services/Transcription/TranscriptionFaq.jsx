...
import BasicAccordion from "../translation/Accordion";
...
export default function TranscriptionFaq() {
  return (
    <>
      <div className="bg-[#100f13] ">
        <div className=" p-4 py-20  flex  bg-[#100f13] w-10/12 m-auto ">
          <div className="w-1/2   mb-4">
            <h1 className="w-3/4 text-6xl text-[#ffffff] font-light ">
