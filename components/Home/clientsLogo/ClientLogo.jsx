  ...
  return (
    <>
      <div className="bg-[#F9F9F9]">
        <h1 className="py-10 sm:py-12 font-Roboto text-center font-bold text-zinc-700 text-4xl">
          Our Clients
        </h1>

        <div className="w-full  sm:w-3/4 md:w-10/12  xl:pb-6  flex-wrap justify-center m-auto flex gap-8 lg:gap-16 px-4 xl:gap-20 items-center">
          ...
          <span className="hover:scale-125 cursor-pointer">
            <img
              ...
              alt="glance logo"
              className=" w-[80px] h-auto lg:w-[120px] lg:h-auto"
            />
          </span>
          ...
          <span className="hover:scale-125 cursor-pointer">
            <img
              ...
              alt="glance logo"
              className="w-[70px] h-auto sm:w-[180px] sm:h-auto md:w-[200px] md:h-auto  "
            />
          </span>

          <span className="hover:scale-125 cursor-pointer">
            <img
              src="/clientLogo/interglobe.png"
              alt="glance logo"
              className="w-[70px] h-auto lg:w-[120px] lg:h-auto"
            />
          </span>

          <span className="hover:scale-125 cursor-pointer">
            <img
              src="/clientLogo/icici_prudential.png"
              alt="glance logo"
              className="w-[70px] h-auto lg:w-[120px] lg:h-auto"
            />
          </span>
          ...
          <span className="hover:scale-125 cursor-pointer">
            <img
              src="/clientLogo/appolo_tyres.png"
              alt="glance logo"
              className="w-[70px] h-auto lg:w-[120px] lg:h-auto "
            />
          </span>
          ...
          <span className="hover:scale-125 cursor-pointer">
            <img
              src="/clientLogo/byjus_logo.svg"
              alt="glance logo"
              className="w-[70px] h-auto  bg-[#813588] p-2 lg:w-[120px] lg:h-auto"
            />
          </span>

          <span className="hover:scale-125 cursor-pointer">
            <img
              src="/clientLogo/kajaria.png"
              alt="glance logo"
              className="w-[70px] h-auto  lg:w-[120px] lg:h-auto"
            />
          </span>
          ...
          <span className="hover:scale-125 cursor-pointer">
            <img
              src="/clientLogo/planetSpark.png"
              alt="glance logo"
              className="w-[70px] h-auto  lg:w-[120px] lg:h-auto"
            />
          </span>
          ...
          <span className="hover:scale-125 cursor-pointer">
            <img
              src="/clientLogo/magicbricks.svg"
              alt="glance logo"
              className="w-[70px] h-auto  bg-red-600 p-2 lg:w-[120px] lg:h-auto"
            />
          </span>
        </div>
      </div>
