          ...
          {value?.map(({ file, progress }, i) => (
            ...
            >
              <div className="flex items-center gap-2 text-gray-500 dark:text-white">
                <AiFillFile size="30" className="shrink-0" />
                ...
                <div className="flex w-12 justify-end text-xs">
                  {progress === "PENDING" ? (
                    ...
                    >
                      <BiSolidTrashAlt className="shrink-0" />
                    </button>
                  ) : progress === "ERROR" ? (
                    <AiOutlineWarning className="shrink-0 text-red-600 dark:text-red-400" />
                  ) : progress !== "COMPLETE" ? (
                    <div>{Math.round(progress)}%</div>
                  ) : (
                    <AiOutlineCheckCircle className="shrink-0 text-green-600 dark:text-gray-400" />
                  )}
                </div>
              </div>
              {/* Progress Bar */}
